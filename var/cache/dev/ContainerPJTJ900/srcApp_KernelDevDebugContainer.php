...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder32369 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializera6e47 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties0dd2c = [
        
    ];

    public function getConnection()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getConnection', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getMetadataFactory', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getExpressionBuilder', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'beginTransaction', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->beginTransaction();
    }

    public function getCache()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getCache', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getCache();
    }

    public function transactional($func)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'transactional', array('func' => $func), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'wrapInTransaction', array('func' => $func), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'commit', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->commit();
    }

    public function rollback()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'rollback', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getClassMetadata', array('className' => $className), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'createQuery', array('dql' => $dql), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'createNamedQuery', array('name' => $name), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'createQueryBuilder', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'flush', array('entity' => $entity), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'clear', array('entityName' => $entityName), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->clear($entityName);
    }

    public function close()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'close', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->close();
    }

    public function persist($entity)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'persist', array('entity' => $entity), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'remove', array('entity' => $entity), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'refresh', array('entity' => $entity), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'detach', array('entity' => $entity), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'merge', array('entity' => $entity), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getRepository', array('entityName' => $entityName), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'contains', array('entity' => $entity), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getEventManager', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getConfiguration', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'isOpen', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getUnitOfWork', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getProxyFactory', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'initializeObject', array('obj' => $obj), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'getFilters', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'isFiltersStateClean', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'hasFilters', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return $this->valueHolder32369->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializera6e47 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder32369) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder32369 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder32369->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, '__get', ['name' => $name], $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        if (isset(self::$publicProperties0dd2c[$name])) {
            return $this->valueHolder32369->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder32369;
    ...
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, '__set', array('name' => $name, 'value' => $value), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;
    ...
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, '__isset', array('name' => $name), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;
    ...
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, '__unset', array('name' => $name), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;
    ...
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, '__clone', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        $this->valueHolder32369 = clone $this->valueHolder32369;
    }

    public function __sleep()
    {
        $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, '__sleep', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;

        return array('valueHolder32369');
    }
    ...
    {
        $this->initializera6e47 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializera6e47;
    }

    public function initializeProxy() : bool
    {
        return $this->initializera6e47 && ($this->initializera6e47->__invoke($valueHolder32369, $this, 'initializeProxy', array(), $this->initializera6e47) || 1) && $this->valueHolder32369 = $valueHolder32369;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder32369;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder32369;
    }
}
